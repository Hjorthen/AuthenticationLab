...
public interface PrinterInterface extends Remote{
	...
	void restart(SignedObject accessToken) throws RemoteException, rmi.AuthenticationException;   /**Stops the print server, clears the print queue and starts the print server again*/
	String status(SignedObject accessToken) throws RemoteException, rmi.AuthenticationException;  /**Prints status of printer on the user's display*/
	String readConfig(String parameter, SignedObject accessToken) throws RemoteException, rmi.AuthenticationException;   /**Prints the value of the parameter on the user's display*/
	void setConfig(String parameter, String value, SignedObject accessToken) throws RemoteException, rmi.AuthenticationException;   /**Sets the parameter to value*/
